...
from core.utils import NI_DEVICE_NAME, UNITY_DEVICE_ID, ARDUINO_DEVICE_NAME, UNITY_DEVICE_NAME, LIVEAMP_DEVICE_NAME_BRAINVISION, EEG_NAME
...
if reaching_trajectory:
    exp_data = make_experiment_data(exclude_participants=['SUB20', 'SUB14'], exclusive_participants=[], exclude_device_data=[NI_DEVICE_NAME, ARDUINO_DEVICE_NAME, EEG_NAME, LIVEAMP_DEVICE_NAME_BRAINVISION, UNITY_DEVICE_NAME], lazy_closure=True)
else:
    exp_data = make_experiment_data(exclude_participants=['SUB20', 'SUB14'], exclusive_participants=[], exclude_device_data=[NI_DEVICE_NAME, ARDUINO_DEVICE_NAME, EEG_NAME, LIVEAMP_DEVICE_NAME_BRAINVISION], lazy_closure=True)
