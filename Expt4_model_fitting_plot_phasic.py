...
from core.utils import NI_DEVICE_NAME, ARDUINO_DEVICE_NAME, LIVEAMP_DEVICE_NAME_BRAINVISION, LIVEAMP_DEVICE_NAME, EEG_NAME, UNITY_DEVICE_NAME
...
if cache:
    exp_data = make_experiment_data(exclusive_participants=[], exclude_participants=['SUB14', 'SUB20'], exclude_device_data=[NI_DEVICE_NAME, ARDUINO_DEVICE_NAME, LIVEAMP_DEVICE_NAME, LIVEAMP_DEVICE_NAME_BRAINVISION, EEG_NAME, UNITY_DEVICE_NAME])
else:   
    exp_data = make_experiment_data(exclusive_participants=[], exclude_participants=['SUB14', 'SUB20'], exclude_device_data=[NI_DEVICE_NAME, ARDUINO_DEVICE_NAME, LIVEAMP_DEVICE_NAME, LIVEAMP_DEVICE_NAME_BRAINVISION, EEG_NAME])
