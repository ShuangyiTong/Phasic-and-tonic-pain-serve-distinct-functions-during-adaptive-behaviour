...
if all_collection_rates:
    exp_data = make_experiment_data(exclude_participants=exclude_participants, exclusive_participants=[], exclude_device_data=[NI_DEVICE_NAME, ARDUINO_DEVICE_NAME, EEG_NAME, LIVEAMP_DEVICE_NAME_BRAINVISION, UNITY_DEVICE_NAME])
else:
    exp_data = make_experiment_data(exclude_participants=exclude_participants, exclusive_participants=[], exclude_device_data=[NI_DEVICE_NAME, ARDUINO_DEVICE_NAME, EEG_NAME, LIVEAMP_DEVICE_NAME_BRAINVISION])
