...
from core.utils import NI_DEVICE_NAME, UNITY_DEVICE_NAME, UNITY_DEVICE_ID, ARDUINO_DEVICE_NAME, nannorm, nan_square_sum, EEG_NAME, LIVEAMP_DEVICE_NAME_BRAINVISION
...
exp_data = make_experiment_data(exclusive_participants=[], exclude_participants=[], exclude_device_data=[NI_DEVICE_NAME, ARDUINO_DEVICE_NAME, EEG_NAME, LIVEAMP_DEVICE_NAME_BRAINVISION], lazy_closure=True)
