...
m = lmer_test.lmer('seen_coef ~ PainFunc + (1 + PainFunc | Subject)', r_from_pd_df)
print(base.summary(m))
...
m = lmer_test.lmer('seen_coef ~ rating + (1 + rating | Subject)', r_from_pd_df)
print(base.summary(m))
print(rstats.confint(m))
...
m = lmer_test.lmer('pick_coef ~ PainFunc + (1 + PainFunc | Subject)', r_from_pd_df)
print(base.summary(m))
print(rstats.confint(m))
...
m = lmer_test.lmer('pick_coef ~ rating + (1 + rating | Subject)', r_from_pd_df)
print(base.summary(m))
print(rstats.confint(m))
