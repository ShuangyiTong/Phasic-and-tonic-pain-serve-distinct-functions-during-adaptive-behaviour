...
from core.utils import NI_DEVICE_NAME, ARDUINO_DEVICE_NAME, LIVEAMP_DEVICE_NAME_BRAINVISION, LIVEAMP_DEVICE_NAME, UNITY_DEVICE_NAME, EEG_NAME
...
set_expt('Expt4')
exp_data = make_experiment_data(exclude_participants=['SUB14', 'SUB20'], exclude_device_data=[NI_DEVICE_NAME, ARDUINO_DEVICE_NAME, UNITY_DEVICE_NAME, LIVEAMP_DEVICE_NAME_BRAINVISION, EEG_NAME])
